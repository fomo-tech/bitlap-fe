...
const MainTabbar = () => {
    ...
    return (
        <div data-v-e697ea1f="" className="tab-bar">
            <div data-v-e697ea1f=""
            ...
            >
                <svg
                    data-v-e697ea1f=""
                    className="inline-block tab-icon"
                    viewBox="0 0 256 256"
                    width="1.2em"
                    height="1.2em"
                >
            ...
            >
                ...
                <span data-v-e697ea1f="">  {t("tabbar.earn")}</span>
            </div>
            <div data-v-e697ea1f="" 
                className={clsx("tab-item", {
            ...
            >
                ...
                <span data-v-e697ea1f="">  {t("tabbar.activity")}</span>
            </div>
            <div data-v-e697ea1f="" 
                className={clsx("tab-item", {
                    "active": pathname === '/vip'
            ...
            >
                ...
                <span data-v-e697ea1f="">  {t("tabbar.profile")}</span>
            </div>
        </div >
