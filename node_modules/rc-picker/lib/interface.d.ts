...
export declare type CellRenderInfo<DateType> = {
...
export declare type CellRender<DateType, CurrentType = DateType> = (current: CurrentType, info: CellRenderInfo<DateType>) => React.ReactNode;
