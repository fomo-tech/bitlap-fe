...
import type { PickerPanelToken } from 'antd/es/date-picker/style';
...
declare const _default: (prefixCls: string) => import("antd/es/theme/interface").UseComponentStyleResult;
